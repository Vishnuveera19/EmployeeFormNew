    ...
    if (isToday(date)) {
      setOpenDialog(true);
       ...
       var obj={
        ...
        "pnEmployeeId": 1,
        "dayStatus": "Present",
        "intime": dt.getFullYear()+"-"+(dt.getMonth()+1).toString().padStart(2,'0')+"-"+(dt.getDate()).toString().padStart(2,'0')+"T"+dt.getHours().toString().padStart(2,'0')+":"+dt.getMinutes().toString().padStart(2,'0')+":"+(dt.getSeconds()).toString().padStart(2,'0')+"."+"000",//dt.getFullYear()+"-"+dt.getMonth()+"-"+dt.getDay()+"T"+dt.getHours()+":"+dt.getMinutes()+":"+dt.getSeconds()+"."+"000",
        "outtime": "2024-04-23T18:00:46.867"
    }
    console.log(obj)
    console.log(dt.getFullYear()+"-"+(dt.getMonth()+1).toString().padStart(2,'0')+"-"+(dt.getDate()).toString().padStart(2,'0')+"T"+(dt.getHours()).toString().padStart(2,'0')+":"+dt.getMinutes()+":"+dt.getSeconds()+"."+"000")
       postRequest(ServerConfig.url,NATTENDANCE,obj).then((e)=>{
         // console.log(e.data)
